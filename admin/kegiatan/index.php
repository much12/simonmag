                            ...
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $data = mysqli_query($koneksi, "select * from t_kegiatan join t_user on t_kegiatan.user_id = t_user.user_id where t_user.user_username = '$username'");
                                                ...
                                                <td style="text-align:center;">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="" class="dropdown-item" data-toggle="modal" data-target="#edit<?php echo $d['kegiatan_id']; ?>"><span class="fa fa-edit" /> Edit</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a href="" class="dropdown-item" data-toggle="modal" data-target="#delete<?php echo $d['kegiatan_id']; ?>"><span class="fa fa-trash" /> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <div class="modal fade" id="delete<?php echo $d['kegiatan_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Data kegiatan yang anda pilih akan dihapus.<br>Apakah anda yakin ingin hapus data?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                <a href="delete.php?kegiatan_id=<?php echo $d['kegiatan_id']; ?>" class="btn btn-primary">Oke</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="modal fade" id="edit<?php echo $d['kegiatan_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="edit.php?kegiatan_id=<?php echo $d['kegiatan_id']; ?>">
                                                                    <?php
                                                                    $id = $d['kegiatan_id'];
                                                                    $data_edit = mysqli_query($koneksi, "select * from t_kegiatan where t_kegiatan.kegiatan_id = '$id'");
                                                                    while ($row = mysqli_fetch_array($data_edit)) { ?>
                                                                        <div class="form-group-sm">
                                                                            <label for="display">Tanggal :</label>
                                                                            <input type="date" name="tanggal" class="form-control" value="<?php echo $row['tanggal_kegiatan']; ?>" required="required"><br>
                                                                        </div>
                                                                        <div class="form-group-sm">
                                                                            <label for="display">Kegiatan :</label>
                                                                            <input type="text" name="kegiatan" class="form-control" value="<?php echo $row['nama_kegiatan']; ?>" required="required"><br>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                            <input type="submit" name="btnlogin" value="Simpan" class="btn btn-primary">
