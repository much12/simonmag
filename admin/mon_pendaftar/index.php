                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $data = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where (peserta_status='2' or peserta_status='3') and bidang_id='$bidang' order by peserta_id asc");
                                                ...
                                                <td style="text-align:center;">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="../../uploads/<?= $d['surat_pengantar'] ?>" class="dropdown-item" target="_blank">
