...
<hr/>
<br>
<center><h4>Peserta Magang</h4></center>
<br><br>
<center>
    <table class="table table-bordered" style="width:90%;">
		...
		$data = mysqli_query($koneksi,"select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and peserta_status != '2' and peserta_status != '3' order by peserta_id asc");   
