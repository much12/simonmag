                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $users = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and (peserta_status='0' or peserta_status='1')");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $user = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and peserta_status='1'");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $user = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and peserta_status='0'");
                                            $cek2 = mysqli_num_rows($user);
                                            ?>
                                            <div class="stat-text"><span class="count"><?php echo $cek2; ?></span></div>
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $report = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and (peserta_status = '2' or peserta_status = '3')");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $report = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and peserta_status = '3'");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $report = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id=t_peserta.peserta_id join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang'");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $report = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id=t_peserta.peserta_id join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and laporan_status='1'");
                                            $cek5 = mysqli_num_rows($report);
                                            ?>
                                            <div class="stat-text"><span class="count"><?php echo $cek5; ?></span></div>
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $report = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id=t_peserta.peserta_id join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and laporan_status='2'");
                                            $cek5 = mysqli_num_rows($report);
                                            ?>
                                            <div class="stat-text"><span class="count"><?php echo $cek5; ?></span></div>
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <?php
                                            $report = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id=t_peserta.peserta_id join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and laporan_status='0'");
                                            $cek5 = mysqli_num_rows($report);
                                            ?>
                                            <div class="stat-text"><span class="count"><?php echo $cek5; ?></span></div>
