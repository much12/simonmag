                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="cetak_aksi2.php?nim=<?php echo $nim; ?>" target="_blank" class="btn btn-info" style="float:right;"><span class="fa fa-print" /> Cetak</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $data = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id = t_peserta.peserta_id join t_user on t_peserta.peserta_nim=t_user.user_username where bidang_id='$bidang' and t_laporan.laporan_status = '2' order by t_laporan.laporan_id asc");
