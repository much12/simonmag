							...
							<div class="card-body">
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
										...
										$data = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where (peserta_status='0' or peserta_status='1') and bidang_id='$bidang' order by peserta_id asc");
