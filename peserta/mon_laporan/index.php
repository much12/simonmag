							...
							<div class="card-body">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="POST" action="add.php">
													...
													<div class="form-group-sm">
														<?php
														$idpiljwbn = mysqli_query($koneksi, "select * from t_peserta where peserta_nim='$username' order by peserta_id asc");
														while ($ipil = mysqli_fetch_array($idpiljwbn)) { ?>
															<input type="hidden" name="peserta" class="form-control" value="<?php echo $ipil['peserta_id']; ?>" placeholder="<?php echo $ipil['peserta_nama']; ?>">
														<?php
														} ?>
													</div>
													<div class="form-group-sm">
														...
														$idpiljwbn = mysqli_query($koneksi, "select * from t_peserta where peserta_nim='$username' order by peserta_id asc");
														while ($ipil = mysqli_fetch_array($idpiljwbn)) { ?>
															<input type="text" name="peserta2" class="form-control" value="<?php echo $ipil['peserta_nama']; ?>" required="required" disabled><br>
														<?php
														} ?>
													</div>
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
										<?php
										$no = 1;
										$data = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id = t_peserta.peserta_id where t_laporan.laporan_status = '0' and t_peserta.peserta_nim = '$username' order by t_laporan.laporan_id asc");
												...
												<td style="text-align:center;">
													<div class="btn-group">
														...
														<div class="dropdown-menu">
															<a href="" class="dropdown-item" data-toggle="modal" data-target="#edit<?php echo $d['laporan_id']; ?>"><img src="../../img/icon_edit.png" alt="Edit" title="Edit Data" /> Edit Data</a>
															<?php if ($d['laporan_status'] == '0') { ?>
																<div class="dropdown-divider"></div>
																<a href="" class="dropdown-item" data-toggle="modal" data-target="#delete<?php echo $d['laporan_id']; ?>"><img src="../../img/icon_delete.png" alt="Delete" title="Delete Data" /> Delete Data</a>
																...
																<form method="POST" action="edit.php?laporan_id=<?php echo $d['laporan_id']; ?>">
																	...
																	while ($row = mysqli_fetch_array($data_edit)) { ?>
																		<div class="form-group-sm">
																			...
																			<?php } elseif ($d['laporan_status'] == '1') { ?>
																				<input type="date" name="tanggal" class="form-control" value="<?php echo $row['laporan_tanggal']; ?>" readonly><br>
