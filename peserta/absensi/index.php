                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="absen.php" class="btn btn-info" style="float:right;"><span class="fa fa-gift"></span> Absen</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $data = mysqli_query($koneksi, "select * from t_absensi where t_absensi.peserta_id='$username'");
                                        while ($d = mysqli_fetch_array($data)) {
                                        ?>
                                            <tr height="30px">
                                                <td style="text-align:center;"><?php echo $no++; ?></td>
                                                <td><?php echo $d['tanggal_absensi']; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
