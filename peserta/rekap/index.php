                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
								...
								<a href="cetak_aksi.php" target="_blank" class="btn btn-info" style="float:right;"><span class="fa fa-print"/> Cetak</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<?php 
										...
										$data = mysqli_query($koneksi,"select * from t_laporan join t_peserta on t_laporan.peserta_id = t_peserta.peserta_id where t_laporan.laporan_status = '1' and t_peserta.peserta_nim='$username' order by t_laporan.laporan_id asc");   
