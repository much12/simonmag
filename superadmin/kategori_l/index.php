                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-user"></i><a href="#">&nbsp;Kategori Laporan</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Kategori Laporan</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = mysqli_query($koneksi, "select * from t_kategori_l order by laporan_status asc");
                                        while ($d = mysqli_fetch_array($data)) {
                                        ?>
                                            <tr>
                                                <td style="text-align:center;"><?php echo $no++; ?></td>
                                                <td><?php echo $d['laporan_status']; ?></td>
                                                <td><?php echo $d['kategori_laporan']; ?></td>
                                            </tr>
                                        <?php }
                                        ?>
                                    </tbody>
