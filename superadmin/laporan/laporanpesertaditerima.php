                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Laporan Peserta Magang Diterima</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <strong class="card-title mb-0">Laporan Peserta Magang Diterima</strong>

                                <a href="export_laporanpesertaditerima.php" class="btn btn-danger btn-sm">
