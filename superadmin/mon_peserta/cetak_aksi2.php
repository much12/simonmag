...
<hr/>
<br>
<center><h4>Laporan Kegiatan Ditolak</h4></center><br><br>
<?php 
	include '../../koneksi.php';
	$username = $_GET['nim'];
...
<center>
    <table class="table table-bordered" style="width:90%;">
		...
		<?php
		$no = 1;
		$data2 = mysqli_query($koneksi,"select * from t_laporan join t_peserta on t_laporan.peserta_id = t_peserta.peserta_id where t_peserta.peserta_nim = '$username' and laporan_status='2' order by t_laporan.laporan_id asc");
