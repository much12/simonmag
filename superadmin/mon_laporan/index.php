                            ...
                            <div class="card-body">
                                                ...
                                                <form method="POST" action="add.php">
                                                    ...
                                                    <div class="form-group-sm">
                                                        ...
                                                        <select name="peserta" class="form-control" required="required">
                                                            ...
                                                            <?php
                                                            $idpiljwbn = mysqli_query($koneksi, "select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username order by peserta_id asc");
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = mysqli_query($koneksi, "select * from t_laporan join t_peserta on t_laporan.peserta_id = t_peserta.peserta_id join t_user on t_peserta.peserta_nim=t_user.user_username where t_laporan.laporan_status='0' order by t_laporan.laporan_id asc");
