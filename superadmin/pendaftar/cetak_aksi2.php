...
<hr/>
<br>
<center><h4>PENDAFTAR MAGANG DITOLAK</h4></center>
<br><br>
<center>
    <table class="table table-bordered" style="width:90%;">
		...
		include '../../koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from t_peserta join t_user on t_peserta.peserta_nim=t_user.user_username where peserta_status = '3' order by peserta_id asc");   
